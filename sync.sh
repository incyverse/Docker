...
# the installation and usage of app with docker-sync.
...
display_options () {
    ...
    print_style "   up [service]" "success"; printf "\t Starts docker-sync and runs docker compose.\n"
